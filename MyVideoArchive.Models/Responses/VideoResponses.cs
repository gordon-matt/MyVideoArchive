...
public record VideoPlaybackInfoResponse(string ContentType);

public record VideoSubtitleItem(string Lang, string Label, bool IsAutoGenerated, string Url);

public record GetVideoSubtitlesResponse(IReadOnlyList<VideoSubtitleItem> Subtitles);

public record SubtitleFileInfo(string FilePath, string Lang);